...
public final class VowelCountServiceClient implements VowelCountService {
  ...
  private final java.util.function.Function<? super org.reactivestreams.Publisher<proteus.example.service.vowelcount.VowelCountResponse>, ? extends org.reactivestreams.Publisher<proteus.example.service.vowelcount.VowelCountResponse>> countVowels;
  ...
  @java.lang.Override
  public reactor.core.publisher.Flux<proteus.example.service.vowelcount.VowelCountResponse> countVowels(org.reactivestreams.Publisher<proteus.example.service.vowelcount.VowelCountRequest> messages, io.netty.buffer.ByteBuf metadata) {
    return rSocket.requestChannel(reactor.core.publisher.Flux.from(messages).map(
      ...
      })).map(deserializer(proteus.example.service.vowelcount.VowelCountResponse.parser())).transform(countVowels);
  }
