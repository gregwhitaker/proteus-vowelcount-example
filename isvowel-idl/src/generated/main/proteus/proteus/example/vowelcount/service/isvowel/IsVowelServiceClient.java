...
public final class IsVowelServiceClient implements IsVowelService {
  ...
  private final java.util.function.Function<? super org.reactivestreams.Publisher<proteus.example.vowelcount.service.isvowel.IsVowelResponse>, ? extends org.reactivestreams.Publisher<proteus.example.vowelcount.service.isvowel.IsVowelResponse>> isVowel;
  ...
  public IsVowelServiceClient(io.rsocket.RSocket rSocket, io.micrometer.core.instrument.MeterRegistry registry) {
    this.rSocket = rSocket;
    this.isVowel = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.client", "namespace", "proteus.example.vowelcount.service.isvowel", "service", "IsVowelService", "method", "isVowel");
  }

  public reactor.core.publisher.Mono<proteus.example.vowelcount.service.isvowel.IsVowelResponse> isVowel(proteus.example.vowelcount.service.isvowel.IsVowelRequest message) {
    return isVowel(message, io.netty.buffer.Unpooled.EMPTY_BUFFER);
  }

  @java.lang.Override
  public reactor.core.publisher.Mono<proteus.example.vowelcount.service.isvowel.IsVowelResponse> isVowel(proteus.example.vowelcount.service.isvowel.IsVowelRequest message, io.netty.buffer.ByteBuf metadata) {
    ...
    }).map(deserializer(proteus.example.vowelcount.service.isvowel.IsVowelResponse.parser())).transform(isVowel);
  }
